...
export function ResetPassword() {
  ...
  useEffect(() => {
    ...
    const checkSession = async () => {
      ...
      if (!session) {
        toast.error('Havola yaroqsiz yoki muddati tugagan');
        navigate('/login');
      }
    };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-purple-900 flex items-center justify-center px-4 relative overflow-hidden">
        ...
        <motion.div
          ...
          className="max-w-md w-full bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 relative z-10 border border-white/20 text-center"
        >
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
          ...
          >
            ...
            3 soniyadan so'ng login sahifasiga yo'naltirilasiz.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
