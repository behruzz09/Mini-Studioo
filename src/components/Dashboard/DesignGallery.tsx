                    ...
                    {selectedDesign.merchandise_urls.map((url, index) => (
                      <div key={index} className="bg-gray-50 rounded-lg p-4">
                        ...
                        <button
                          ...
                          className={`mt-3 px-4 py-2 rounded-lg flex items-center space-x-2 ${profile?.role === 'user' && !profile?.isPro ? 'bg-gray-200 text-gray-400 hover:bg-gray-300' : 'bg-green-600 text-white hover:bg-green-700 transition-colors'}`}
                        >
                          <Download className="h-4 w-4" />
                          <span>Download</span>
                        </button>
